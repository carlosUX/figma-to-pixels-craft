  ...
  return <div className="max-w-none flex flex-col w-full bg-white min-h-screen">
      ...
      <div className="w-full px-6 md:px-12 lg:px-36 py-4 bg-zinc-400">
        <div className="flex flex-col w-full max-w-[1054px] mx-auto">
          <h3 className="font-semibold text-lg mb-4 text-zinc-100">What would you like to build?</h3>
        ...
        <div className="flex flex-col w-full max-w-[1054px]">
          ...
          <div className="w-full max-w-[1054px] mb-12">
            ...
            <div className="mb-8 bg-white rounded-lg p-6 border border-gray-200">
              ...
              {!wantsHelp && <button onClick={toggleHelp} className="bg-blue-100 text-blue-800 hover:bg-blue-200 px-4 py-2 rounded-lg float-right">
                  Yes, please
                </button>}
              
              {wantsHelp && <p className="text-green-600 italic">
            ...
            <div className="mb-6">
              ...
              <Input placeholder="Enter common tasks" value={taskInput1} onChange={e => setTaskInput1(e.target.value)} className="w-full p-4 border border-gray-300 rounded-lg" />
            </div>
            ...
            <div className="mb-10">
              ...
              <Input placeholder="Enter common tasks" value={taskInput2} onChange={e => setTaskInput2(e.target.value)} className="w-full p-4 border border-gray-300 rounded-lg" />
            </div>
          </div>
