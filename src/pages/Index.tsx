...
const Index: React.FC = () => {
  return (
    <div className="max-w-none flex flex-col w-full bg-white mx-auto">
      <Header />
      <main className="flex flex-col items-center px-4 sm:px-8 md:px-12 lg:px-36 py-4 sm:py-6 bg-zinc-200">
        <InputSection />
        {/* <RelatedInformation /> */}
